...
import '../../../data/spot/spot_request.dart';
...
class SearchLocationController extends GetxController{
  ...
  Future<void> searchSpotByCoordinate() async {
    SpotRequest req = SpotRequest(
        ...
        latitude: markerPosition.value.latitude,
        longitude: markerPosition.value.longitude,
        queryType: "ADDRESS",
        searchQuery: "null"
    );
    print("주소로 검색");
    await spotRepository.searchSpotByCoordinate(req);
  }
